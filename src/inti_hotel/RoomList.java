...
//this class has been created for the room list  by Utilizing a Doubly  linked list 
    ...
    public void delete(String key) { // to delete specifc node
        ...
        while (current != null) {
            ...
            {
                deleteAtStart();//consider the key is the first node in the list
            }
            else
            {
    ...
    /*
    public void addAfter(DllNode current, String addAfter, String data) {
    ...
    public void save_in_file() // to save the avaiable room to be booked  by the customer 
    {
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("RoomList.txt"));
